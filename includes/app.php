 ...
 *
 */
define('SYSTEM_NAME','Web Harmony');
define('SYSTEM_URI','http://localhost/projectsend/index.php');
define('SYSTEM_URI_LABEL','Web Harmony 2024');
define('DONATIONS_URL','http://localhost/projectsend/index.php');
 ...
 */
define('NEWS_FEED_URI','http://localhost/projectsend/index.php');

/**
 * Define the Feed from where to take the latest version
 * number.
 */
define('UPDATES_FEED_URI','http://localhost/projectsend/index.php');
